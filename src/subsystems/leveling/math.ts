...
/**
 * 
 * @param level level to calculate required points for
...
/**
 * 
 * Inverse of calculateRequiredPoints
 * @param points number of points
 * @returns level
 */
export function calculateLevelFromPoints(points: number): number {
    // L = (-15 + sqrt(20 * XP - 175)) / 10
    return Math.floor((-15 + Math.sqrt(20 * points - 175)) / 10);
}
